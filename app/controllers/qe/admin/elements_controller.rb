  ...
  module Admin 
    class ElementsController < Qe::Admin::AdminControllers
      ...
      # GET /admin/question_sheets/1/pages/1/elements/1/edit
      # GET /admin/question_sheets/1/pages/1/elements/1/edit.json
      def edit
        ...
        respond_to do |format|
          format.js
          format.json { render json: @element } # TODO need to cover situation if element is question
        end
      end

      # GET /admin/question_sheets/1/pages/1/elements/new
      def new
      ...
      # POST /admin/question_sheets/1/pages/1/elements/1/use_existing
      def use_existing
        @element = Qe::Element.find(params[:id])
      ...
      # POST /admin/question_sheets/1/pages/1/elements/create
      def create
      ...
      # PUT /admin/question_sheets/1/pages/1/elements/1
      def update
        @element = Qe::Element.find(params[:id])
      ...
      # DELETE /admin/question_sheets/1/pages/1/elements/1
      def destroy
        @element = Qe::Element.find(params[:id])
